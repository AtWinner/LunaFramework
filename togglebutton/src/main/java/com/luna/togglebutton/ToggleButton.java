...
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.LunaToggleButton);
        offBorderColor = typedArray.getColor(R.styleable.LunaToggleButton_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.LunaToggleButton_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.LunaToggleButton_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.LunaToggleButton_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.LunaToggleButton_toggleBorderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.LunaToggleButton_animate, defaultAnimate);
        isDefaultOn = typedArray.getBoolean(R.styleable.LunaToggleButton_isDefaultOn, isDefaultOn);
        typedArray.recycle();
